 ...
 */
class getLigneAchatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LigneAchatRepository' shared autowired service.
     *
     * @return \App\Repository\LigneAchatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LigneAchatRepository.php';

        return $container->privates['App\\Repository\\LigneAchatRepository'] = new \App\Repository\LigneAchatRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
