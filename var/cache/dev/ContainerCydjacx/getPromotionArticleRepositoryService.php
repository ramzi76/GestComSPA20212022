 ...
 */
class getPromotionArticleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PromotionArticleRepository' shared autowired service.
     *
     * @return \App\Repository\PromotionArticleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PromotionArticleRepository.php';

        return $container->privates['App\\Repository\\PromotionArticleRepository'] = new \App\Repository\PromotionArticleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
