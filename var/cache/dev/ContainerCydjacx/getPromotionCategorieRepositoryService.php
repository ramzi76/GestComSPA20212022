 ...
 */
class getPromotionCategorieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PromotionCategorieRepository' shared autowired service.
     *
     * @return \App\Repository\PromotionCategorieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PromotionCategorieRepository.php';

        return $container->privates['App\\Repository\\PromotionCategorieRepository'] = new \App\Repository\PromotionCategorieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
