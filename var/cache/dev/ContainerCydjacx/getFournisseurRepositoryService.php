 ...
 */
class getFournisseurRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FournisseurRepository.php';

        return $container->privates['App\\Repository\\FournisseurRepository'] = new \App\Repository\FournisseurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
