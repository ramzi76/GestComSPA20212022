                    ...
                    if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["decision"], "voter_details", [], "any", false, false, false, 402))) {
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["voter_detail"]) {
                            ...
                            echo "</td>
                                                            ";
                            // line 410
                            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 410, $this->source); })()), "voterStrategy", [], "any", false, false, false, 410), twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\AccessDecisionManager::STRATEGY_UNANIMOUS")))) {
                                // line 411
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "C:\\xampp\\htdocs\\GestComSPA\\vendor\\symfony\\security-bundle\\Resources\\views\\Collector\\security.html.twig");
    }
}
